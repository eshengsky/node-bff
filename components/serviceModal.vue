      ...
      <div class="drawer-body">
        <el-form label-position="top">
          <el-form-item
            ...
            prop="key"
          >
            <el-input v-model="serviceClone.name" class="name-input" placeholder="该接口的唯一标识，如 api1" />
            <small v-if="serviceClone.name" class="name-tip"><i class="el-icon-info" /> 在后续流程中，你可以通过 <code>context.${{ serviceClone.name }}</code> 访问到该接口的响应对象</small>
          </el-form-item>
          <el-form-item
            prop="path"
            label="接口路径"
          ...
          >
            <el-tabs v-model="currentTab" type="border-card">
              ...
              <el-tab-pane name="header" class="tab-panel">
                ...
                <service-params :params-list="serviceClone.headerParams" :params-autocomplete="headerAutoList" />
              </el-tab-pane>
            </el-tabs>
          </el-form-item>
        </el-form>
